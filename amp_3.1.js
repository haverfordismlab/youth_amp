	...
	function ampExtension(options)
	{
		...
		var ampObj = 
		{
			...
			base_url : {//Where are your images at?
				image : 'https://https://app-prod-03.implicit.harvard.edu/implicit/user/bkinsler1/amp testing/'
			}, 
		...
		var layout2 = [
            {media:{image:'Thumbs down.png'}, size:{height:30,width:18.75}, location:{right:0}, data:{handle:'right'}},
			{media:{image:'Thumbs up.png'}, size:{height:30,width:18.75}, location:{left:0}, data:{handle:'left'}},
			...
			interactions: [
				...
				},
				{
					...
					actions: [
						...
						{type:'resetTimer'},
						//Add keyboard input
						{type:'setInput',input:{handle:leftSortingLabel,on: 'click', stimHandle:'left'}},
						{type:'setInput',input:{handle:rightSortingLabel,on: 'click', stimHandle:'right'}},
